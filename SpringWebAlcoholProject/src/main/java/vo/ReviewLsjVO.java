...
public class ReviewLsjVO {
    ...
    public int getReview_del_info() {
        return review_del_info;
    }

    public void setReview_del_info(int review_del_info) {
        this.review_del_info = review_del_info;
    }

    private int review_del_info;
