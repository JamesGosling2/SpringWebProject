                    ...
                    <article class="blog-details">
                        ...
                        <div class="company">
                            <form action="producerName.do" id="go_select">
                                ...
                                <!-- 아이콘 -->
                                <span class="company com_text"
                                      onclick="show(this.form);">[${ vo1.producer_name }]</span>
                            </form>
                        </div>
                        ...
                        <div style="width: 100%;">
                            ...
                            <div class="input_number" style="width: 100%;">
                                <div class="btn-group" role="group" aria-label="Basic example" style="width: 100%;">
                                    <button type="button" class="btn btn-primary min_left" onclick="cal('-');">-
                                    </button>
                                    <span class="btn btn-primary center" id="center">0</span>
                                    <button type="button" class="btn btn-primary plus_right_btn" onclick="cal('+');">+
                                    </button>
                                </div>
                            </div>
                        </div>
